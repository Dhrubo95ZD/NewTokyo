# Moretti: Blackwood City — Google Play listing

## App details

- App name: `Moretti: Blackwood City`
- Default language: English (United States)
- App or game: Game
- Category: Role Playing
- Suggested tags: Crime, Role Playing, Multiplayer, Simulation
- Online requirement: Internet connection required
- Recommended target audience: Adults only; complete the Play content-rating questionnaire honestly

## Short description

Build your name through missions, careers, trading and a persistent online city.
...
`Blackwood City skyline with the Moretti title and missions, careers, families and trade highlighted.`
