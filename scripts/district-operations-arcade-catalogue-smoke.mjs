...
const sql=fs.readFileSync("supabase/20260916_district_operations_arcade_catalogue.sql","utf8"),ui=fs.readFileSync("src/operations/DistrictOperations.jsx","utf8"),css=fs.readFileSync("src/operations/district-operations.css","utf8"),game=fs.readFileSync("src/MafiaGame.jsx","utf8")+fs.readFileSync("src/ui/navigation.js","utf8").replaceAll(String.fromCharCode(39), String.fromCharCode(34)),arcade=fs.readFileSync("src/casino/CasinoHub.jsx","utf8"),catalogue=fs.readFileSync("src/catalogue/ItemCatalogue.jsx","utf8"),art=fs.readFileSync("src/catalogue/ItemArtwork.jsx","utf8"),catalogueCss=fs.readFileSync("src/catalogue/item-catalogue.css","utf8");
...
assert.match(game,/\["operations",\s*"District Operations"\]/);assert.match(game,/\["arcade",\s*"Arcade"\]/);assert.match(arcade,/The Arcade/);assert.doesNotMatch(game,/Rossi's Casino|"Casino"/);
