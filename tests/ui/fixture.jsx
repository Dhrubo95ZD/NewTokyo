...
const operations = () => ({player:{...player},active:null,grind:{today:2,nextEfficiency:1},districts:[{id:'harbor',name:'The Harbor',zone:'SOUTH DOCKS',accent:'#9b6742',summary:'Control the manifests and the waterfront routes.',threat:1,heat:12,mastery:40,clears:4,operations:[{id:'harbor-manifest',name:'The Missing Manifest',briefing:'Recover a sealed manifest from an NPC crew.',captainName:'Foreman Rusk',difficulty:1,requiredLevel:1,baseCash:900,baseXp:14,rareChance:.02}]}]});
const rise = () => ({authority:true,parts:84,player:{...player},bosses:[{id:'boss-harbor',districtId:'harbor',districtName:'The Harbor',accent:'#9b6742',name:'Silas Rook',title:'The Dockmaster',briefing:'Break Rook’s control of the sealed manifests before the next tide.',weakness:'careful',requiredLevel:4,requiredMastery:30,requiredClears:3,partsReward:35,rewardName:'Harbor Iron',rewardRarity:'rare',wins:1,losses:0,mastery:40,clears:4,unlocked:true,cooldownSeconds:0}],recipes:[{id:'field-revolver',partsCost:60,requiredLevel:12,requiredBossId:'boss-harbor',bossDefeated:true,owned:0,item:{id:'catalog-07-revolver',name:'Iron Revolver',description:'A workshop-ready service revolver.',rarity:'uncommon'}}],inventory:[{id:'catalog-02-revolver',item_id:'catalog-02-revolver',name:'Street Revolver',rarity:'common',quantity:2,available:2,upgradeRank:0,upgradeCost:25}]});
