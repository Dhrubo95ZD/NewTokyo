...
export default function CasinoHub({ onLedgerChange = null, onCashChange = null }) {
  ...
  return <div className="casino-page"><header><small>ROSSI'S RECREATION HALL</small><h1>The Arcade</h1><p>Blackjack, slots and roulette use play-earned Arcade Dollars from the same wallet as Prime FX. Every result is recorded by the city server.</p><div className="virtual-currency-notice"><b>ARCADE DOLLARS · $</b><span>Shared with Prime FX · cannot be bought with city cash or real money · verified net wins may redeem one-way into ordinary in-game cash</span></div></header>{error&&<div className="casino-error">{error}</div>}
