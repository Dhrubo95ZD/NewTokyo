export const GROUPS = [
  ...
  { id: 'city', label: 'City', icon: 'city', pages: [['city','City directory'],['civic','Civic Contracts'],['shop','Security & Tools'],['market','Player Market'],['bank','Federal Trust'],['economy','Market Desk'],['property','Properties'],['arcade','Arcade'],['hospital','Hospital'],['jail','Jail']] },
