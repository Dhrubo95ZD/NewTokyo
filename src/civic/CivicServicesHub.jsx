...
export default function CivicServicesHub({ onState, onNavigate }) {
  ...
  return <section className="civic-page">
    ...
    <section className="civic-section">
      <header><div><small>CHARITY HOUSE · COMMUNITY FUND</small><h2>Community Fund</h2><p>Optional donations are cash-only contributions. There is no interest, chance reward, or hidden fee.</p></div><b>{projects.filter(project => project.complete).length}/{projects.length} complete</b></header>
