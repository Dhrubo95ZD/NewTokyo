...
function City({ go }) {
  ...
  return <><PageHead eyebrow="BLACKWOOD DIRECTORY" title="The City" text="One canonical door for every service. Search the district, then enter the system you need." /><section className="bw-city-directory">
